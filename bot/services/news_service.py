...
RSS_SOURCES = [
    ...
    {
        "name": "Спорт-Экспресс",
        "url": "https://www.sport-express.ru/news/rss.xml",
        "category": "sports",
    },
]
...
KEYWORDS = [
    ...
    # мировой спорт — Еврокубки / сборные
    "чемпионат мира", "олимпиад", "лига чемпионов",
    "лига европы", "лига конференций", "champions league", "europa league",
    "conference league", "евро 2024", "евро 2025", "евро 2026",
    "чемпионат европы", "лига наций", "nations league",
    "fifa", "uefa", "nba", "нба", "формула 1",
    "уимблдон", "wimbledon", "ролан гаррос",
    "сборная", "гран-при", "кубок мира",
    # UFC / Бокс
    "ufc", "бой за титул", "чемпионский бой", "чемпион мира по боксу",
    "нокаут", " tko ", "wbc", "wba", "wbo", "ibf", "мма", "единоборств",
    # крипта
